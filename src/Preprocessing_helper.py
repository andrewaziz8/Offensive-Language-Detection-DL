...
#load data
def load_data():
  raw_data_df = pd.read_csv('https://query.data.world/s/twuhmzuhvitwqqcjh5picrq3qykr4r') #change
#   raw_data_df = pd.read_csv('/content/drive/MyDrive/Advanced_ML_Project/Offensive-Language-Detection-DL/data/labeled_data_clean_tweet.csv') #change
  return raw_data_df
...
def preprocessing_tweet(tweet_df):
  temp_list= []
  for t in tweet_df['tweet']: #change: the original is 'tweet'. change it to 'clean_tweet'. instead of text
